...
<template>
  ...
  <div v-else>
    ...
    <form v-on:submit.prevent="save()">
      ...
      <p class="centered-input">
        <button type="button" :disabled="saving || testing" v-on:click="test">{{ t('majordomo', 'Test IMAP Connection')
          }}
        </button>
    ...
    <p class="centered-input">
      <button type="button" :disabled="saving || processing" v-on:click="process">
