...
return [
    'routes' => [
        ...
        ['name' => 'api#getBounces', 'url' => '/api/bounces', 'verb' => 'GET'],
        ['name' => 'api#getBounce', 'url' => '/api/bounces/{uid}', 'verb' => 'GET'],
        ['name' => 'api#approveBounce', 'url' => '/api/bounces/{uid}/approve', 'verb' => 'POST'],
        ['name' => 'api#rejectBounce', 'url' => '/api/bounces/{uid}/reject', 'verb' => 'POST'],
