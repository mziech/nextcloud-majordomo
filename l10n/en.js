OC.L10N.register("majordomo", {
  ...
  "Bounces": "Bounces",
  "Cancel": "Cancel",
  "Choose the kind of membership entry to add": "Choose the kind of membership entry to add",
  "Choose the user or group to add or exclude": "Choose the user or group to add or exclude",
  ...
  "IMAP Bounces folder name": "IMAP Bounces folder name",
